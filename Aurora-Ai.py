...
# Load the custom font and animations
st.markdown(
    """
    <style>
...
if not st.session_state.api_key:
    ...
    if "chat_messages" not in st.session_state:
        st.session_state.groq_chat_messages = [{"role": "system", "content": "You are Aurora, an AI chatbot made specifically for providing information related to sustainable lifestyle. You are required to answer all the questions or queries asked by the user. If enough information isn't provided by the user, you are required to ask the user for appropriate queries, but if the user greets you or thanks you, respond nicely."}]
    ...
    # Handle user input
    if prompt := st.chat_input("Ask Aurora something or say hi to her"):
